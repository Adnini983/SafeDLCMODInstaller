...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_GOTY2010CN.xdelta"  :: 要校验的目标文件
set "expected_md5=5B7AA91CAABA8FF55309C7D93A2EA408"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_GOTY2010CN.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_GOTY2010CN.xdelta"  :: 要校验的目标文件
set "expected_md5=361AB713B233C3BD014F7DDDDB2F20C9"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_GOTY2010CN.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
