...
set "expected_md5=2422B3D75601BCF8592177455417B9AC"  :: 预期的MD5值
...
set "expected_md5=2DFE8F8A132C9C7E93B41B72BB6947B1"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_1051CNV2.xdelta"  :: 要校验的目标文件
set "expected_md5=b3b609637d3ace0de80fd5bb03669d96"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_1051CNV2.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_1051CNV2.xdelta"  :: 要校验的目标文件
set "expected_md5=afa223efc54da72c1da9e076c95fcf51"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_1051CNV2.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
...
echo(☑ main.pak
echo(☑ exe_1051CNV2.xdelta
echo(☑ pak_1051CNV2.xdelta
...
xdelta3-3.0.11-x86_64.exe -d -s PlantsVsZombies.exe exe_1051CNV2.xdelta PATCH.exe
echo 修补 main.pak
xdelta3-3.0.11-x86_64.exe -d -s main.pak pak_1051CNV2.xdelta PATCH.pak
echo 删除多余的文件(如果有)
rmdir /s/q compiled
rmdir /s/q font
rmdir /s/q data
