...
set "expected_md5=29E703D8B36DF8CC8F5BB65C991557BD"  :: 预期的MD5值
...
set "expected_md5=8BBA56D3790E36449BA51A9E50E7BAD7"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_1051Decrypted.xdelta"  :: 要校验的目标文件
set "expected_md5=57698c40c719fdf6bc39fa2138ff9b33"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_1051Decrypted.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_1051Decrypted.xdelta"  :: 要校验的目标文件
set "expected_md5=6a657e3ab618229dcc5c3745ae803b9e"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_1051Decrypted.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
