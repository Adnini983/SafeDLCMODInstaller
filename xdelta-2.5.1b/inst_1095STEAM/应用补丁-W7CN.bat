...
set "expected_md5=C79E7580FCFF978AFAB35CAEACBF3BA6"  :: 预期的MD5值
...
set "expected_md5=26392C2433CAFF44251B9EECD4500546"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_1095STEAM.xdelta"  :: 要校验的目标文件
set "expected_md5=07d48824ddd9acf0d567f0c91bad9c95"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_1095STEAM.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_1095STEAM.xdelta"  :: 要校验的目标文件
set "expected_md5=9765aeafbe0f97bf2af739be30091ebc"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_1095STEAM.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
