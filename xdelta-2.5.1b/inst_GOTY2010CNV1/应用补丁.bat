...
set "expected_md5=9E214F8FB21EE01592E15BFE1A2F3E41"  :: 预期的MD5值
...
set "expected_md5=F49E18BDFEF6656E45F6C974B64A0B79"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_GOTY2010CNV1.xdelta"  :: 要校验的目标文件
set "expected_md5=0b6e7522b44c2908f4388126d66d9875"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_GOTY2010CNV1.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_GOTY2010CNV1.xdelta"  :: 要校验的目标文件
set "expected_md5=97c6e1335bc7dc2e5e9c952fa2691280"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_GOTY2010CNV1.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
...
echo(☑ main.pak
echo(☑ exe_GOTY2010CNV1.xdelta
echo(☑ pak_GOTY2010CNV1.xdelta
...
xdelta3-3.0.11-x86_64.exe -d -s PlantsVsZombies.exe exe_GOTY2010CNV1.xdelta PATCH.exe
echo 修补 main.pak
xdelta3-3.0.11-x86_64.exe -d -s main.pak pak_GOTY2010CNV1.xdelta PATCH.pak
echo 删除多余的文件(如果有)
rmdir /s/q .\compiled
rmdir /s/q .\data
rmdir /s/q .\images
