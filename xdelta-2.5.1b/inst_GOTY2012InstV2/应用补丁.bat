...
set "expected_md5=da6af0df4f0d78ee4e632771b4f239a9"  :: 预期的MD5值
...
set "expected_md5=0c1189d8444a742c6fd174dcb8803e44"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_GOTY2012InstV2.xdelta"  :: 要校验的目标文件
set "expected_md5=27c060e4add43602d0ff3831935f5a54"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_GOTY2012InstV2.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_GOTY2012InstV2.xdelta"  :: 要校验的目标文件
set "expected_md5=de7b22d3a9960679b86080f45d16f47c"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_GOTY2012InstV2.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
...
echo(☑ main.pak
echo(☑ exe_GOTY2012InstV2.xdelta
echo(☑ pak_GOTY2012InstV2.xdelta
...
xdelta3-3.0.11-x86_64.exe -d -s PlantsVsZombies.exe exe_GOTY2012InstV2.xdelta PATCH.exe
echo 修补 main.pak
xdelta3-3.0.11-x86_64.exe -d -s main.pak pak_GOTY2012InstV2.xdelta PATCH.pak
echo 删除多余的文件(如果有)
rmdir /s/q .\compiled
rmdir /s/q .\data
rmdir /s/q .\images
