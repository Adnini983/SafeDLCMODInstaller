...
set "expected_md5=90e267b872c8ad294411e9f3673018b1"  :: 预期的MD5值
...
set "expected_md5=f2eb7aee732c9cee271e543f3111482e"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_GOTY2012V1.xdelta"  :: 要校验的目标文件
set "expected_md5=c969b5342b2ea5b9ca79640c4dfd076e"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_GOTY2012V1.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_GOTY2012V1.xdelta"  :: 要校验的目标文件
set "expected_md5=b29d090d5db33b405302af60e82e0407"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_GOTY2012V1.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
