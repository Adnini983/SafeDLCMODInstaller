...
set "expected_md5=462bfabf5f40962dbc71e3bc28ec746b"  :: 预期的MD5值
...
set "expected_md5=b15a35c766261596fa95f923c4e7f00b"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
:: 配置文件校验参数
:: ========================================
set "target_file=exe_GOTY2012V2.xdelta"  :: 要校验的目标文件
set "expected_md5=55aafcb263dc3cf490ab567ab63055b7"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. exe_GOTY2012V2.xdelta 文件是否存在
...
:: 配置文件校验参数
:: ========================================
set "target_file=pak_GOTY2012V2.xdelta"  :: 要校验的目标文件
set "expected_md5=6497fbef8bd1218a2d9431cc5cee4419"  :: 预期的MD5值
set "error_count=0"  :: 错误计数器
...
echo.
echo 程序因错误终止，请检查以下内容：
echo 1. pak_GOTY2012V2.xdelta 文件是否存在
echo 2. 如果存在 可能是文件损坏 请重新下载或重新解压
...
echo(☑ main.pak
echo(☑ exe_GOTY2012V2.xdelta
echo(☑ pak_GOTY2012V2.xdelta
...
xdelta3-3.0.11-x86_64.exe -d -s PlantsVsZombies.exe exe_GOTY2012V2.xdelta PATCH.exe
echo 修补 main.pak
xdelta3-3.0.11-x86_64.exe -d -s main.pak pak_GOTY2012V2.xdelta PATCH.pak
echo 删除多余的文件(如果有)
rmdir /s/q ..\compiled
rmdir /s/q ..\data
rmdir /s/q ..\images
